      ...
      <div className="relative z-10 w-full max-w-md px-6 py-8 flex flex-col items-center justify-center text-center">
        ...
        <form onSubmit={handleSubmit} className="w-full mb-6 relative z-30">
          <input
            ...
            autoComplete="off"
            className="w-full bg-[#f5f5f5] border-2 border-[#D4AF37] rounded-lg py-3 px-4 text-center text-lg mb-4 outline-none focus:ring-2 focus:ring-[#D4AF37] text-[#1a1a1a] placeholder:text-[#888] placeholder:opacity-100 relative z-30 cursor-text"
